...
# --- CONFIGURATION ---
# Ensure this matches your new filename in the /data folder
FILENAME = 'candidate_sites.csv' 

# Path logic: Up two levels from scripts/DONE to ColoradoH2_Analysis, then down to data
SCRIPT_DIR = Path(__file__).resolve().parent
INPUT_FILE = SCRIPT_DIR.parent.parent / 'data' / FILENAME
OUTPUT_FILE = INPUT_FILE.parent / f"geocoded_{FILENAME}"
